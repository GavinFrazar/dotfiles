;;; ayuu-theme.el --- an Emacs 24 theme based on ayuu (tmTheme)
;;
...
;;  from ayuu (tmTheme) by Ike Ku
;;
;;; Code:

(deftheme ayuu
  "ayuu-theme - Created by tmtheme-to-deftheme - 2017-01-15 15:58:27 -0700")
...
(custom-theme-set-faces
 ...
 ;; Temporary defaults
 '(linum                               ((t (:foreground "darkgray"  :background "#1C212C" ))))
 '(fringe                              ((t (:background "#333942" ))))

 '(minibuffer-prompt                   ((t (:foreground "#1278A8"  :background nil :weight bold))))
 '(escape-glyph                        ((t (:foreground "#95E6CB"   :background nil))))
 '(highlight                           ((t (:foreground nil :background "#191D26"))))
 '(shadow                              ((t (:foreground "#777777"  :background nil))))

 '(trailing-whitespace                 ((t (:foreground "#FF0000"  :background "#C74000"))))
 ...
 '(mode-line-highlight                 ((t (:background "#000000" :box nil))))
 '(mode-line-emphasis                  ((t (:weight bold))))
 '(mode-line-buffer-id                 ((t (:foreground "#FFFFFF" :underline "RED" :box nil :weight bold))))
 ...
 '(isearch                             ((t (:foreground "#99ccee"  :background "darkblue"))))
 '(isearch-fail                        ((t (                       :background "red"))))
 '(lazy-highlight                      ((t (:background "black"))))
;; '(match                               ((t (:background "#3388cc"))))
 ...
 '(font-lock-comment-face ((t (:foreground "#5aa63f" :background nil :italic t))))
 '(font-lock-variable-name-face ((t (:foreground "#D9D7CE"  ))))
 '(font-lock-keyword-face ((t (:foreground "#eb9823"  ))))
 '(font-lock-constant-face ((t (:foreground "#e284f5"  ))))
 '(git-gutter:deleted ((t (:foreground "#5CCFE6"))))
 '(font-lock-function-name-face ((t (:foreground "#ffcc66"  ))))
 '(font-lock-builtin-face ((t (:foreground nil  ))))
 '(font-lock-string-face ((t (:foreground "#00ff0d"  :normal t))))
 ...
 '(font-lock-comment-delimiter-face ((t (:foreground "#5aa63f"  :italic t))))
